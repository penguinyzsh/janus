...
object WallpaperUtils {
    ...
    fun detectWallpaper(): WallpaperPaths? {
        ...
        return try {
            ...
            android.util.Log.w("Janus-Wallpaper", "detectWallpaper failed", e)
            null
        }
    }
    ...
    private fun buildMrcFromTemplate(context: Context, videoFile: File, enableLoop: Boolean): File? {
        ...
        try {
            ZipOutputStream(FileOutputStream(resultMrc)).use { zos ->
                fun addAsset(assetPath: String, zipPath: String) {
                    ...
                    if (children.isEmpty()) {
                        ...
                        } catch (e: Exception) { android.util.Log.w("Janus-Wallpaper", "asset read failed: $assetPath", e); return }
            ...
            android.util.Log.w("Janus-Wallpaper", "buildMrcFromTemplate failed", e)
            resultMrc.delete()
            return null
        }
    }
